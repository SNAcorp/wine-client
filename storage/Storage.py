...
class Storage:
    ...
    __button_Pin_led = {1: (0x20, 4), 2: (0x20, 5), 3: (0x20, 6), 4: (0x20, 7),
                        5: (0x22, 4), 6: (0x22, 5), 7: (0x22, 6), 8: (0x22, 7)}

    __led_bottle = {1: (0x23, 0), 2: (0x23, 1), 3: (0x23, 2), 4: (0x23, 3),
                    5: (0x23, 4), 6: (0x22, 3), 7: (0x23, 6), 8: (0x23, 7)}
    """ Пины для взимодействия с сигналом кнопок """
    __button_Pin = {1: (0x20, 0), 2: (0x20, 1), 3: (0x20, 2), 4:(0x20, 3),
                    5: (0x22, 0), 6: (0x22, 1), 7: (0x22, 2), 8: (0x22, 3)}

    """ Пины для управления насосами (диспенсером) """
    __pump_Pin = {1: (0x21, 0), 2: (0x21, 1), 3: (0x21, 2), 4: (0x21, 3),
                  5: (0x21, 4), 6: (0x21, 5), 7: (0x21, 6), 8: (0x21, 7)}
